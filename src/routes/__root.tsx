...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MealNest – Homemade Goodness, Delivered Daily" },
      { property: "og:description", content: "Fresh homemade meals from trusted home chefs, delivered daily by MealNest." },
